    ...
    return array(
        ...
        ->group(function()
        {
            return array(
                ...
                'linkers' => Route::add('linker_key', ['_route' => 'addon_linkers', ])
                    ...
                    return array(
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'values' => Route::add('value_id', ['_route' => 'addon_linkers_linker_key_values', ])
                    ...
                    return array(
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'branch-restrictions' => Route::add('id', ['_route' => 'repositories_workspace_repo_slug_branch_restrictions', ])
                                    ...
                                    return array(
                                        ...
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                'comments' => Route::add('comment_id', ['_route' => 'repositories_workspace_repo_slug_commit_commit_comments', ])
                                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_commit_commit_comments_comment_id', ]),

                                                'properties' => Route::add('app_key', [])
                                                ->rule('any', [], [])
                                                ->group(function()
                                                {
                                                    return array(
                                                ...
                                                'reports' => Route::add('reportId', ['_route' => 'repositories_workspace_repo_slug_commit_commit_reports', ])
                                                    ...
                                                    return array(
                                                        ...
                                                        ->group(function()
                                                        {
                                                            return array(
                                                                ...
                                                                'annotations' => Route::add('annotationId', ['_route' => 'repositories_workspace_repo_slug_commit_commit_reports_reportId_annotations', ])
                                                ...
                                                ->group(function()
                                                {
                                                    return array(
                                                        ...
                                                        'build' => Route::add('key', ['_route' => 'repositories_workspace_repo_slug_commit_commit_statuses_build', ])
                                ...
                                'commits' => Route::add('revision', ['_route' => 'repositories_workspace_repo_slug_commits', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_commits_revision', ]),

                                'components' => Route::add('component_id', ['_route' => 'repositories_workspace_repo_slug_components', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_components_component_id', ]),

                                'default-reviewers' => Route::add('target_username', ['_route' => 'repositories_workspace_repo_slug_default_reviewers', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_default_reviewers_target_username', ]),

                                'deploy-keys' => Route::add('key_id', ['_route' => 'repositories_workspace_repo_slug_deploy_keys', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_deploy_keys_key_id', ]),

                                'deployments' => Route::add('deployment_uuid', ['_route' => 'repositories_workspace_repo_slug_deployments', ])
                                ...
                                ->group(function()
                                {
                                    return array(
                                        ...
                                        'environments' => Route::add('environment_uuid', [])
                                        ->rule('any', [], [])
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                ->group(function()
                                                {
                                                    return array(
                                                        ...
                                                        'variables' => Route::add('variable_uuid', ['_route' => 'repositories_workspace_repo_slug_deployments_config_environments_environment_uuid_variables', ])
                                ...
                                'downloads' => Route::add('filename', ['_route' => 'repositories_workspace_repo_slug_downloads', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_downloads_filename', ]),

                                'environments' => Route::add('environment_uuid', ['_route' => 'repositories_workspace_repo_slug_environments', ])
                                ...
                                'hooks' => Route::add('uid', ['_route' => 'repositories_workspace_repo_slug_hooks', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_hooks_uid', ]),

                                'issues' => Route::add('issue_id', ['_route' => 'repositories_workspace_repo_slug_issues', ])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_issues_issue_id', ])
                                ->group(function()
                                {
                                    return array(

                                        'export' => Route::add('repo_name}-issues-{task_id}.zip', ['_route' => 'repositories_workspace_repo_slug_issues_export', ])
                                        ...
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                'attachments' => Route::add('path', ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_attachments', ])
                                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_attachments_path', ]),

                                                'changes' => Route::add('change_id', ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_changes', ])
                                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_changes_change_id', ]),

                                                'comments' => Route::add('comment_id', ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_comments', ])
                                ...
                                'milestones' => Route::add('milestone_id', ['_route' => 'repositories_workspace_repo_slug_milestones', ])
                                ...
                                ->group(function()
                                {
                                    return array(
                                        ...
                                        'caches' => Route::add('cache_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_caches', ])
                                ...
                                'pipelines' => Route::add('pipeline_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines', ])
                                    ...
                                    return array(
                                        ...
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                'steps' => Route::add('step_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_pipeline_uuid_steps', ])
                                                            ...
                                                            return array(
                                                                ...
                                                                ->group(function()
                                                                {
                                                                    return array(
                                                                        ...
                                                                        'test_cases' => Route::add('test_case_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_pipeline_uuid_steps_step_uuid_test_reports_test_cases', ])
                                                                        ->rule('any', [], [])
                                                                        ->group(function()
                                                                        {
                                                                            return array(
                                ...
                                ->group(function()
                                {
                                    return array(
                                        ...
                                        'schedules' => Route::add('schedule_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_schedules', ])
                                        ...
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                'known_hosts' => Route::add('known_host_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_ssh_known_hosts', ])
                                        ...
                                        'variables' => Route::add('variable_uuid', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_variables', ])
                                ...
                                'pullrequests' => Route::add('pullrequest_id', ['_route' => 'repositories_workspace_repo_slug_pullrequests', ])
                                    ...
                                    return array(
                                        ...
                                        ->group(function()
                                        {
                                            return array(
                                                ...
                                                'comments' => Route::add('comment_id', ['_route' => 'repositories_workspace_repo_slug_pullrequests_pull_request_id_comments', ])
                                ...
                                ->group(function()
                                {
                                    return array(
                                        ...
                                        'branches' => Route::add('name', ['_route' => 'repositories_workspace_repo_slug_refs_branches', ])
                                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_refs_branches_name', ]),

                                        'tags' => Route::add('name', ['_route' => 'repositories_workspace_repo_slug_refs_tags', ])
                                ...
                                'src' => Route::add('commit', ['_route' => 'repositories_workspace_repo_slug_src', ])
                                ->rule('any', [], [])
                                ->group(function()
                                {
                                    return array(
                                ...
                                'versions' => Route::add('version_id', ['_route' => 'repositories_workspace_repo_slug_versions', ])
        ...
        'snippets' => Route::add('workspace', ['_route' => 'snippets', ])
                    ...
                    return array(
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'comments' => Route::add('comment_id', ['_route' => 'snippets_workspace_encoded_id_comments', ])
                                ->rule('any', [], ['_route' => 'snippets_workspace_encoded_id_comments_comment_id', ]),

                                'commits' => Route::add('revision', ['_route' => 'snippets_workspace_encoded_id_commits', ])
        ...
        'teams' => Route::add('workspace', ['_route' => 'teams', ])
            ...
            return array(
                ...
                ->group(function()
                {
                    return array(
                        ...
                        'hooks' => Route::add('uid', ['_route' => 'teams_username_hooks', ])
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'repositories' => Route::add('repo_slug', ['_route' => 'teams_username_permissions_repositories', ])
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'variables' => Route::add('variable_uuid', ['_route' => 'teams_username_pipelines_config_variables', ])
                        ...
                        'projects' => Route::add('project_key', ['_route' => 'teams_username_projects', ])
        ...
        ->group(function()
        {
            return array(
                ...
                'emails' => Route::add('email', ['_route' => 'user_emails', ])
            ...
            return array(
                ...
                ->group(function()
                {
                    return array(
                        ...
                        'hooks' => Route::add('uid', ['_route' => 'users_selected_user_hooks', ])
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'variables' => Route::add('variable_uuid', ['_route' => 'users_selected_user_pipelines_config_variables', ])
                        ...
                        'ssh-keys' => Route::add('key_id', ['_route' => 'users_selected_user_ssh_keys', ])
        ...
        'workspaces' => Route::add('workspace', ['_route' => 'workspaces', ])
            ...
            return array(
                ...
                ->group(function()
                {
                    return array(
                        ...
                        'hooks' => Route::add('uid', ['_route' => 'workspaces_workspace_hooks', ])
                        ->rule('any', [], ['_route' => 'workspaces_workspace_hooks_uid', ]),

                        'members' => Route::add('member', ['_route' => 'workspaces_workspace_members', ])
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'repositories' => Route::add('repo_slug', ['_route' => 'workspaces_workspace_permissions_repositories', ])
                        ...
                        ->group(function()
                        {
                            return array(
                                ...
                                'variables' => Route::add('variable_uuid', ['_route' => 'workspaces_workspace_pipelines_config_variables', ])
                        ...
                        'projects' => Route::add('project_key', ['_route' => 'workspaces_workspace_projects', ])
