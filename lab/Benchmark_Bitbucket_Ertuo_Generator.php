...
class Benchmark_Bitbucket_Ertuo_Generator extends Benchmark_Ertuo
{
    function loadRoutes() : Route 
    {
        ...
        ->group(function()
        {
            ...
            ->group(function()
            {
                yield 'linkers' => Route::add('', ['_route' => 'addon_linkers'])
            ...
            yield 'hook_events' => Route::add('', ['_route' => 'hook_events'])
            ->rule('any', [], ['_route' => 'hook_events_subject_type']);

            yield 'pullrequests' => Route::add('', ['_route' => 'pullrequests'])
            ->rule('any', [], ['_route' => 'pullrequests_selected_user']);

            yield 'repositories' => Route::add('', ['_route' => 'repositories'])
            ...
            ->group(function()
            {
                ...
                ->group(function()
                {
                    ...
                    ->group(function()
                    {
                        ...
                        yield 'commit' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commit'])
                        ...
                        ->group(function()
                        {
                            ...
                            ->group(function()
                            {
                                ...
                                yield 'comments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commit_commit_comments'])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_commit_commit_comments_comment_id']);

                                yield 'properties' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commit_commit_properties'])
                                ...
                                yield 'reports' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commit_commit_reports'])
                                ...
                                ->group(function()
                                {
                                    yield 'build' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commit_commit_statuses_build'])
                        ...
                        yield 'commits' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_commits'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_commits_revision']);

                        yield 'components' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_components'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_components_component_id']);

                        yield 'default-reviewers' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_default_reviewers'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_default_reviewers_target_username']);

                        yield 'deploy-keys' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_deploy_keys'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_deploy_keys_key_id']);

                        yield 'deployments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_deployments'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_deployments_deployment_uuid']);

                        yield 'deployments_config' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_deployments_config'])
                        ->group(function()
                        {
                            yield 'environments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_deployments_config_environments'])
                        ...
                        yield 'diff' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_diff'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_diff_spec']);

                        yield 'diffstat' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_diffstat'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_diffstat_spec']);

                        yield 'downloads' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_downloads'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_downloads_filename']);

                        yield 'environments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_environments'])
                        ...
                        yield 'filehistory' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_filehistory'])
                        ...
                        yield 'hooks' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_hooks'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_hooks_uid']);

                        yield 'issues' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_issues'])
                        ->group(function()
                        {
                            yield 'export' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_issues_export'])
                        ...
                        ->group(function()
                        {
                            ...
                            ->group(function()
                            {
                                ...
                                yield 'changes' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_changes'])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_changes_change_id']);

                                yield 'comments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_issues_issue_id_comments'])
                        ...
                        yield 'merge-base' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_merge_base'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_merge_base_revspec']);

                        yield 'milestones' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_milestones'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_milestones_milestone_id']);

                        yield 'patch' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_patch'])
                        ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_patch_spec']);

                        yield 'pipelines-config' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config'])
                        ->group(function()
                        {
                            yield 'caches' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_caches'])
                        ...
                        yield 'pipelines' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines'])
                            ...
                            ->group(function()
                            {
                                ...
                                ->group(function()
                                {
                                    ...
                                    ->group(function()
                                    {
                                        ...
                                        yield 'logs' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_pipeline_uuid_steps_step_uuid_logs'])
                                        ...
                                        ->group(function()
                                        {
                                            yield 'test_cases' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_pipeline_uuid_steps_step_uuid_test_reports_test_cases'])
                        ...
                        ->group(function()
                        {
                            ...
                            yield 'schedules' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_schedules'])
                            ...
                            yield 'ssh' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_ssh'])
                            ->group(function()
                            {
                                yield 'key_pair' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_ssh_key_pair']);

                                yield 'known_hosts' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_ssh_known_hosts'])
                                ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_pipelines_config_ssh_known_hosts_known_host_uuid']);

                            });

                            yield 'variables' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pipelines_config_variables'])
                            ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_pipelines_config_variables_variable_uuid']);

                        });

                        yield 'properties' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_properties'])
                        ...
                        yield 'pullrequests' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pullrequests'])
                        ->group(function()
                        {
                        ...
                        ->group(function()
                        {
                            ...
                            ->group(function()
                            {
                                ...
                                yield 'comments' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pullrequests_pull_request_id_comments'])
                                ...
                                ->group(function()
                                {
                                    yield 'task-status' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_pullrequests_pull_request_id_merge_task_status'])
                        ...
                        ->group(function()
                        {
                            yield 'branches' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_refs_branches'])
                            ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_refs_branches_name']);

                            yield 'tags' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_refs_tags'])
                            ->rule('any', [], ['_route' => 'repositories_workspace_repo_slug_refs_tags_name']);

                        });

                        yield 'src' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_src'])
                        ...
                        yield 'versions' => Route::add('', ['_route' => 'repositories_workspace_repo_slug_versions'])
            ...
            yield 'snippets' => Route::add('', ['_route' => 'snippets'])
            ...
            ->group(function()
            {
                ...
                ->group(function()
                {
                    ...
                    ->group(function()
                    {
                        ...
                        yield 'commits' => Route::add('', ['_route' => 'snippets_workspace_encoded_id_commits'])
                        ->rule('any', [], ['_route' => 'snippets_workspace_encoded_id_commits_revision']);

                        yield 'files' => Route::add('', ['_route' => 'snippets_workspace_encoded_id_files'])
            ...
            yield 'teams' => Route::add('', ['_route' => 'teams'])
            ...
            ->group(function()
            {
                ...
                ->group(function()
                {
                    ...
                    yield 'hooks' => Route::add('', ['_route' => 'teams_username_hooks'])
                    ...
                    ->group(function()
                    {
                        yield 'repositories' => Route::add('', ['_route' => 'teams_username_permissions_repositories'])
                        ->rule('any', [], ['_route' => 'teams_username_permissions_repositories_repo_slug']);

                    });

                    yield 'pipelines_config' => Route::add('', ['_route' => 'teams_username_pipelines_config'])
                    ->group(function()
                    {
                        yield 'variables' => Route::add('', ['_route' => 'teams_username_pipelines_config_variables'])
                        ->rule('any', [], ['_route' => 'teams_username_pipelines_config_variables_variable_uuid']);

                    });

                    yield 'projects' => Route::add('', ['_route' => 'teams_username_projects'])
                    ->rule('any', [], ['_route' => 'teams_username_projects_project_key']);

                    yield 'search' => Route::add('', ['_route' => 'teams_username_search'])
                    ->group(function()
                    {
            ...
            ->group(function()
            {
                yield 'emails' => Route::add('', ['_route' => 'user_emails'])
                ->rule('any', [], ['_route' => 'user_emails_email']);

                yield 'permissions' => Route::add('', ['_route' => 'user_permissions'])
                ->group(function()
                {
            ...
            yield 'users' => Route::add('', ['_route' => 'users'])
            ...
            ->group(function()
            {
                ...
                ->group(function()
                {
                    ...
                    yield 'pipelines_config' => Route::add('', ['_route' => 'users_selected_user_pipelines_config'])
                    ->group(function()
                    {
                        yield 'variables' => Route::add('', ['_route' => 'users_selected_user_pipelines_config_variables'])
                        ->rule('any', [], ['_route' => 'users_selected_user_pipelines_config_variables_variable_uuid']);

                    });

                    yield 'properties' => Route::add('', ['_route' => 'users_selected_user_properties'])
                    ...
                    yield 'search' => Route::add('', ['_route' => 'users_selected_user_search'])
                    ->group(function()
                    {
            ...
            yield 'workspaces' => Route::add('', ['_route' => 'workspaces'])
            ...
            ->group(function()
            {
                ...
                ->group(function()
                {
                    ...
                    yield 'members' => Route::add('', ['_route' => 'workspaces_workspace_members'])
                    ->rule('any', [], ['_route' => 'workspaces_workspace_members_member']);

                    yield 'permissions' => Route::add('', ['_route' => 'workspaces_workspace_permissions'])
                    ->group(function()
                    {
                        yield 'repositories' => Route::add('', ['_route' => 'workspaces_workspace_permissions_repositories'])
                        ->rule('any', [], ['_route' => 'workspaces_workspace_permissions_repositories_repo_slug']);

                    });

                    yield 'pipelines-config' => Route::add('', ['_route' => 'workspaces_workspace_pipelines_config'])
                    ->group(function()
                    {
                        yield 'identity' => Route::add('', ['_route' => 'workspaces_workspace_pipelines_config_identity'])
                        ->group(function()
                        {
                            yield 'oidc' => Route::add('', ['_route' => 'workspaces_workspace_pipelines_config_identity_oidc'])
                            ->group(function()
                            {
                        ...
                        yield 'variables' => Route::add('', ['_route' => 'workspaces_workspace_pipelines_config_variables'])
                        ->rule('any', [], ['_route' => 'workspaces_workspace_pipelines_config_variables_variable_uuid']);

                    });

                    yield 'projects' => Route::add('', ['_route' => 'workspaces_workspace_projects'])
                    ->rule('any', [], ['_route' => 'workspaces_workspace_projects_project_key']);

                    yield 'search' => Route::add('', ['_route' => 'workspaces_workspace_search'])
                    ->group(function()
                    {
